...
./Comparison --numKeys 500k --numQueries 0 --recsplit --bbhash --simdrecsplit --shockhash --rustFmph --rustFmphGo --rustPHast | tee --append /opt/dockerVolume/pareto-zoomed.txt
